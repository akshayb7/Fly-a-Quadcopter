...
In this project, we will design an agent that can fly a quadcopter, and then train it using a reinforcement learning algorithm. We will use the actor-critic methods to do so. We also use a replay buffer to re-use experience.